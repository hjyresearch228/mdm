...
if __name__ == "__main__":
    ...
    data_file_name = "../GeoData/geo.dat"
    index_file_name = "../GeoData/geo.idx"
    range_query_file_name = "../GeoData/rangeQuery_real.txt"
    point_query_file1_name = "../GeoData/pointQuery1_real.txt"
    point_query_file2_name = "../GeoData/pointQuery2_real.txt"
    nx = 200  #
    ny = 200  #
    ...
    ep_start_t = [0, 1228060800, 1230739200, 1233417600, 1235836800, 1238515200, 1241107200, 1243785600, 1246377600,
                  1249056000, 1251734400]
    ep_time = 2678400
